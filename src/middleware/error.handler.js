...
export const USERNAME_ALREADY_EXISTS = "Username is already exists";
export const EMAIL_ALREADY_EXISTS = "Email address is already exists";
export const PHONE_ALREADY_EXISTS = "Phone Number is already exists";
...
export const LINK_EXPIRED = "Link already expired"

export const DEFAULT_ERROR_STATUS = 500;
export const BAD_REQUEST_STATUS = 400;
export const UNAUTHORIZED_STATUS = 401;
export const NOT_FOUND_STATUS = 404;
export const LINK_EXPIRED_STATUS = 410;
